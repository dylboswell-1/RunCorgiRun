...
public static class SpriteTools // static becuse you would only ever need a single SpriteTools object
{
    public static Vector3 ConstrainToScreen(SpriteRenderer spriteRenderer)
    {
        Vector3 screenPosition = Camera.main.WorldToScreenPoint(spriteRenderer.transform.position); // Coverts World Space to Screen Space
